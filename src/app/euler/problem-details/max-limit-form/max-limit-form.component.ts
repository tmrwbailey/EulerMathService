...
export class MaxLimitFormComponent {
  ...
  runSolver(){
    this.eulerSolutionService.runSolver(this.singleProblem.id, Number(this.solverParamForm.value.maxLimit));
  }
}
